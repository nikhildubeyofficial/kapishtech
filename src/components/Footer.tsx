    ...
    <footer className="bg-slate-900 border-t border-white/5 pt-20 pb-10">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-8 max-w-sm">
              We build premium digital products that drive growth. Transforming visionary ideas into exceptional digital experiences with modern technology and stunning design.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li><a href="mailto:hello@kapishtech.com" className="text-slate-400 hover:text-white text-sm transition-colors">hello@kapishtech.com</a></li>
              <li><a href="tel:+919876543210" className="text-slate-400 hover:text-white text-sm transition-colors">+91 98765 43210</a></li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} Kapish Technologies. All rights reserved.</p>
